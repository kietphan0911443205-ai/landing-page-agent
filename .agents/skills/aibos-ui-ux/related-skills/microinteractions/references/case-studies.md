...
A form submission microinteraction covers the moment from when the user taps "Submit" to when they receive confirmation of success or details of failure. It is one of the highest-stakes aibos-ui-ux-microinteractions because users have invested time and data.
...
Notifications are transient aibos-ui-ux-microinteractions that communicate system events without requiring full user attention. They appear, convey a message, and disappear -- but the design details determine whether they are helpful or infuriating.
