...
Error states are what happens when rules are violated or when the system fails. Error handling is where most aibos-ui-ux-microinteractions fall apart -- and where thoughtful design has the most impact on user trust.
...
Edge cases are the boundary conditions where aibos-ui-ux-microinteractions often break. Designing for edge cases means asking "What happens when...?" for every unusual situation.
